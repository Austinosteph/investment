...
export function CustodyArchitecture() {
	return (
		<div className="mt-16 sm:mt-20 md:mt-24 rounded-2xl border border-gray-700 bg-gray-900/50 p-6 sm:p-8 md:p-12">
			<div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
				...
				<div className="flex-1">
					<div className="mb-6 sm:mb-8 flex items-center gap-3">
						<Lock size={20} className="text-brand-light-green shrink-0" />
						<h3 className="text-lg font-bold text-white sm:text-xl lg:text-2xl">
							Fortified Custody Architecture
						</h3>
					</div>

					<p className="mb-6 sm:mb-8 max-w-2xl text-gray-300 text-sm sm:text-base leading-relaxed">
					...
					<div className="mb-6 sm:mb-8 grid gap-4 sm:gap-6 md:grid-cols-2">
						<div className="space-y-2 bg-brand-light-green/5 p-3 sm:p-4 rounded-lg border border-brand-light-green/10">
					...
					<div className="grid gap-6 sm:gap-8 md:grid-cols-2 border-t border-gray-700 pt-6 sm:pt-8">
						<div className="space-y-2">
							...
							<p className="text-xs sm:text-sm text-brand-light-green leading-relaxed">
