				...
				<div className="max-w-7xl mx-auto mb-12 sm:mb-16">
					...
					<div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4 lg:gap-0">
						...
						<div className="flex flex-col sm:flex-row gap-2 sm:gap-3 lg:gap-4 xl:gap-6 p-4">
							<Link
								href="/invest"
								className="flex items-center justify-center gap-2 w-full sm:w-auto px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3 rounded-lg font-semibold text-sm sm:text-base lg:text-lg transition-all hover:shadow-lg hover:scale-105 bg-brand-dark-green text-brand-text-green"
							>
							...
							<Link
								href="/invest"
								className="flex items-center justify-center gap-2 w-full sm:w-auto px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3 rounded-lg font-semibold text-sm sm:text-base lg:text-lg transition-all hover:scale-105 text-brand-light-blue border-2 border-brand-light-blue"
							>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8">
						<div className="bg-neutral-900 border border-neutral-800 rounded-lg p-3 sm:p-4 md:p-6">
						...
						<div className="bg-neutral-900 border border-neutral-800 rounded-lg p-3 sm:p-4 md:p-6">
							...
							<div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-cyan-400 mb-2">
								$142,320.12
							</div>
							<div className="flex gap-2">
								<span className="text-lime-500 text-xs sm:text-sm font-medium">
