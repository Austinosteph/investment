...
const tiers: PricingTier[] = [
	{
		...
		category: 'SHORT TERM',
		roi: 10,
		icon: <ShieldCheck className="w-6 h-6 text-brand-light-green" />,
	...
	},
	{
		...
		popular: true,
		badge: 'POPULAR',
		icon: <Star className="w-6 h-6 text-brand-dark-green" />,
	...
	},
	{
		...
		category: 'WHALE TIER',
		roi: 25,
		icon: <Gem className="w-6 h-6 text-brand-light-blue" />,
			...
			<div className="border border-brand-light-green rounded-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
				...
				<div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
					...
					<div>
						...
						<div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-3 sm:p-4">
					...
					{/* CTA Button */}
					<button className="w-full bg-[#cdff00] text-black font-bold py-2.5 sm:py-3 px-4 rounded-lg hover:bg-[#b8e600] transition-colors duration-200 text-sm sm:text-base">
						Confirm Paid
					</button>
				</div>
			</div>
			...
			<main className="flex-1 p-3 sm:p-4 md:p-6 lg:p-8 text-white overflow-auto">
				<div className="max-w-7xl mx-auto">
					...
					<div className="mb-6 sm:mb-8 lg:mb-12 xl:mb-16">
						<h1 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-white mb-2 sm:mb-3 lg:mb-4">
							Investment Plans
						</h1>
						<p className="text-gray-400 text-xs sm:text-sm lg:text-base max-w-2xl leading-relaxed">
						...
						{tiers.map((tier, index) => (
							<div
								...
								className={`relative rounded-lg border transition-all duration-300 ${
									tier.popular
										? 'border-brand-dark-green shadow-lg shadow-brand-dark-green/20 lg:scale-105 xl:scale-105'
										: 'border-brand-light-green hover:border-brand-dark-green hover:shadow-md hover:scale-102'
								}`}
							>
								{/* Popular Badge */}
								{tier.popular && (
									<div className="absolute -top-2 sm:-top-3 left-1/2 transform -translate-x-1/2 sm:left-1/2 md:left-auto md:right-4 lg:right-6 md:transform-none z-10">
										<div className="bg-brand-dark-green shadow-lg shadow-brand-dark-green/20 text-brand-text-green px-2 sm:px-3 py-1 rounded-full text-xs font-semibold">
											{tier.badge}
										</div>
									</div>
								)}
								...
								<div className="p-4 sm:p-6 lg:p-8">
									...
									<div className="mb-3 sm:mb-4 lg:mb-6 flex flex-col sm:flex-row sm:items-center sm:gap-2">
										<div className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-[#cdff00] mb-1 sm:mb-0">
											{tier.roi}%
										</div>
										<div className="text-xs sm:text-sm text-gray-500">ROI</div>
									</div>
									...
									<div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6 lg:mb-8 pb-4 sm:pb-6 lg:pb-8 border-b border-[#333]">
										<div className="flex items-center gap-2">
											...
											<span className="text-xs sm:text-sm text-brand-light-green">
												{tier.duration}
											</span>
										</div>
										<div className="flex items-center gap-2">
									...
									<button
										...
										className="w-full bg-[#cdff00] text-black font-bold py-2 sm:py-2.5 lg:py-3 px-3 sm:px-4 rounded-lg hover:bg-[#b8e600] transition-all duration-200 text-center text-xs sm:text-sm lg:text-base hover:scale-105"
									>
										Invest Now
									</button>
								</div>
